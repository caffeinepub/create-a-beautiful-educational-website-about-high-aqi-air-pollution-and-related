...
export class Backend implements backendInterface {
    ...
    async getAll(): Promise<Array<ChangeRequest>> {
        if (this.processError) {
            try {
    ...
    async markReviewed(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markReviewed(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitChangeRequest(arg0: ChangeRequestInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitChangeRequest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
